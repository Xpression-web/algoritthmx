...
const DisplayServices = () => {
  ...
  const services = [
    {
      id: '01',
      title: 'Elevate your brand with attractive visuals',
      description: "Display ads and images will be designed to the style of your brand and business.",
      image: '/images/Elevate-your-brand-with-attractive-visuals-01.png',
    },
    {
      id: '02',
      title: 'Reinforce your brand and bring them back',
      description: 'Retarget audiences who have already been exposed to your brand.',
      image: '/images/Reinforce-your-brand-and-bring-them-back-02.png',
    },
    {
      id: '03',
      title: 'Expand your brand and close the deal',
      description: 'Target via placement, demographics, lookalikes, and more. Drive users to action.',
      image: '/images/Expand-your-brand-and-close-deal-03.png',
    },
  ];
