...
return (
    ...
    <div className="max-w-[1200px] mx-auto mt-[50px] mb-[50px]">
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className={` ${styles["what-title"]}`}>Discovery</h2>
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className={` ${styles["what-title"]}`}>Strategy</h2>
            <p className={`${styles["what-description"]}`}>
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className={` ${styles["what-title"]}`}>Creative</h2>
            <p className={`${styles["what-description"]}`}>
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className={` ${styles["what-title"]}`}>Launch</h2>
            <p className={`${styles["what-description"]}`}>
