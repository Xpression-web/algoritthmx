            ...
            <div className="py-6">
              <div className="grid grid-cols-3 items-center gap-4">
                ...
                <div className="col-span-1 flex justify-center">
                  <span className={`text-[56px] leading-[1] font-[800] font-[Helvetica] text-[#DD9933]`}>97%</span>
                </div>
                {/* 2/3 Section */}
                <div className="col-span-2">
                  <span className={`text-[21.6px] leading-[1.1] font-[400] font-[Helvetica] text-[#DD9933]`}>
