    ...
    return (
        ...
        <div className="text-center mb-16">
            <h1 className="text-4xl sm:text-5xl md:text-6xl text-white mb-2">Link Building</h1>
            <h2 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white">Process</h2>
        </div>
