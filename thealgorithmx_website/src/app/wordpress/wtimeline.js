...
const timelineSteps = [
  {
    ...
    title: "Requirements",
    description:
      "Our best WordPress developers work closely with you to establish and finalize the scope of your project.",
    color: "text-red-500",
    dotColor: "bg-red-500",
  },
  {
    ...
    title: "Roadmap",
    description:
      "After reviewing your business goals, our WordPress development company formulates a personalized and structured plan to assist you in accomplishing them.",
    color: "text-red-400",
    dotColor: "bg-red-400",
  },
  {
    ...
    title: "Designing",
    description:
      "In our WordPress theme development process, we carefully plan out the desired UI’s blueprint, and then the wireframes and mockups are given the finishing touches.",
  ...
  },
  {
    ...
    title: "Development",
    description:
      "The next step is custom WordPress store development where we build the store based on your defined specifications.",
  ...
  },
  {
    ...
    title: "Testing",
    description:
      "Our WordPress development company rigorously tests each version of the store built by our talented Magneto developers, ensuring its reliability before sharing it with you.",
  ...
  },
  {
    ...
    title: "Deployment",
    description:
      "The last step in our WordPress website development process is to deploy and make your Magento store live once you are happy with the final result.",
    color: "text-yellow-400",
    dotColor: "bg-yellow-400",
  },
];

const WordPressDevelopmentTimeline = () => {
  return (
...
export default WordPressDevelopmentTimeline;