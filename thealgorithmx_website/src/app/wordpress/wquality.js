    ...
    <h3 className={`${styles["quality-title"]} ${monsterfont.className} font-bold mb-2`}>
      WORTH EVERY PENNY
          ...
          <div className="pl-4 pr-8 py-6 relative z-0">
            <p className={`${styles["quality-description"]} font-helveticaneue text-semi-white leading-relaxed pb-6 px-6 `}>
            AlgorithmX is committed to exploring all possibilities to deliver top-notch and innovative 
            WordPress development services customized to suit all your requirements and surpass your expectations.
            </p>
          </div>
        </div>
      </div>
