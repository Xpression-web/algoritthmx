...
return (
    ...
    <div className="max-w-[1200px] mx-auto mt-[50px] mb-[50px]">
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className={` ${styles["what-title"]}`}>Prospect analysis</h2>
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className={` ${styles["what-title"]}`}>Competitor Analysis</h2>
            <p className={`${styles["what-description"]}`}>
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className={` ${styles["what-title"]}`}>Content Building</h2>
            <p className={`${styles["what-description"]}`}>
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className={` ${styles["what-title"]}`}>On-Page</h2>
            <p className={`${styles["what-description"]}`}>
