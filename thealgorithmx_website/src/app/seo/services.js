...
return (
    ...
    <div className="max-w-[1200px] mx-auto mt-[50px] mb-[50px]">
        <h1 className="text-3xl font-bold mb-10">What sets AlgorithmX’s SEO Services apart</h1>
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className="text-lg font-medium mb-2">Prospect analysis</h2>
            <p>
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className="text-lg font-medium mb-2">Competitor Analysis</h2>
            <p>
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className="text-lg font-medium mb-2">Content Building</h2>
            <p>
        ...
        <div className="bg-black border border-white p-4 flex text-xs items-center">
            ...
            <div>
            <h2 className="text-lg font-medium mb-2">On-Page</h2>
            <p>
