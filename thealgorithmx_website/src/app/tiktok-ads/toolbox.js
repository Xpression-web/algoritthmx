...
const TechnologyToolbox = () => {
  const tools = [
    ...
    { id: 'ak', name: 'Ads Analytics', image: 'images/TikTok-Ads-Analytics.png' },
    { id: 'ps', name: 'Ads Manager', image: 'images/TikTok-Ads-Manager.png' },
    { id: 'id', name: 'Split Testing', image: 'images/TikTok-Ads-Manager-Split-Testing.png' },
    { id: 'canva', name: 'Business Center', image: 'images/TikTok-Business-Center.png' },
    { id: 'creat', name: 'Creative Center', image: 'images/TikTok-Creative-Center.png' },
    { id: 'video', name: 'Video Editor', image: 'images/TikTok-Video-Editor.png' },
  ];
