    ...
    return (
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row gap-8">
            ...
            <div className="grid grid-cols-2 gap-4 mb-2">
                ...
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white  `}>Research</span>
                </div>
                <div className="flex items-center  ">
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white  `}>Optimization</span>
                </div>
                <div className="flex items-center  ">
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white  `}>Content</span>
                </div>
                <div className="flex items-center  ">
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white  `}>Keywords</span>
                </div>
                <div className="flex items-center  ">
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white  `}>Earned Media & Links</span>
                </div>
                <div className="flex items-center  ">
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white  `}>Testing
                </span>
                </div>
                </div>
            <p className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white mb-2`}>
