    ...
    return (
        ...
        <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row gap-8">
            ...
            <div className="grid grid-cols-2 gap-4 mb-2">
                ...
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white mb-[20px] `}>Analyzing site's current mobile SEO health</span>
                </div>
                <div className="flex items-center  ">
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white mb-[20px] `}>Proactively monitoring mobile performance</span>
                </div>
                <div className="flex items-center  ">
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white mb-[20px] `}>Developing mobile-first strategies from the ground up</span>
                </div>
                <div className="flex items-center  ">
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white mb-[20px] `}>Optimizing site to enable a seamless mobile web browsing experience</span>
                </div>
                <div className="flex items-center  ">
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white mb-[20px] `}>Increase mobile site loading speed</span>
                </div>
                <div className="flex items-center  ">
                <span className={`text-[15px] leading-[24px]  font-[400] font-[Helvetica] text-semi-white mb-[20px] `}>Ensure website is bug-free in all mobile environments
                </span>
                </div>
                </div>
            </div>
