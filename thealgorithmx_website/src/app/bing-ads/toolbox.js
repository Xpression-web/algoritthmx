...
const TechnologyToolbox = () => {
  const tools = [
    ...
    { id: 'ps', name: 'Microsoft Ads', image: 'images/Microsoft-Advertising.png' },
    { id: 'id', name: 'Microsoft Clarity', image: 'images/Microsoft-Clarity.png' },
    { id: 'canva', name: 'Power BI', image: 'images/Microsoft-Power-BI.png' },
    ...
    { id: 'un', name: 'Unbounce', image: 'images/Unbounce.png' },
  ];
