  ...
  return (
    <div className="bg-black">
      <div className="flex items-center justify-center p-4 md:p-8 pt-20 md:mt-0">
        ...
        <div className="w-full max-w-[800px] responsive-hero md:w-full  rounded-3xl border border-red-500 relative flex flex-col md:flex-row">
          ...
          <div className="md:w-4/5 flex">
            ...
            <div className="md:w-4/5 flex flex-col items-center md:items-start  mt-40 md:mt-20  text-center md:text-left">
              <h2 className={`hero-img-title text-white ${monsterfont1.className}`}>
                Experience AlgorithmX Today
              </h2>
              <p className={`text-semi-white hero-img-description ${monsterfont1.className} md:max-w-md`}>
