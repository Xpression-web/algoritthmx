...
const TechnologyToolbox = () => {
  const tools = [
    { id: 'ae', name: 'Amazon Advertising', image: 'images/Amazon-Advertising.png' },
    { id: 'fb', name: 'Facebook Ads ', image: 'images/Facebook-Ads-Manager.png' },
    { id: 'hot', name: 'Google Ads', image: 'images/Google-Ads.png' },
    { id: 'ak', name: 'Campaign Manager', image: 'images/LinkedIn-Campaign-Manager.png' },
    { id: 'id', name: 'Microsoft Ads', image: 'images/Microsoft-Advertising.png' },
    { id: 'canva', name: 'Pinterest Ads', image: 'images/Pinterest-Ads-Manager.png' },
    { id: 'ana', name: 'TikTok Ads Manager', image: 'images/TikTok-Ads-Manager.png' },
