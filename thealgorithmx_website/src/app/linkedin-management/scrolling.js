    ...
    <div ref={containerRef} className="bg-black min-h-screen flex justify-center items-center">
      <div className={`${styles["container1"]} w-full max-w-[1200px] mx-auto ${styles["algo-content-creation-services"]}`}>
        ...
        <div className={`${styles["flx_right"]}`}>
          ...
          <div className="mb-8">
            <h2 className={`${styles["scroll-title"]} text-white`} >Build Brand Awareness</h2>
          ...
          <div className="mb-8">
            <h2 className={`${styles["scroll-title"]} text-white`}>Target the Right Audience</h2>
            <p className={`${styles["scroll-description"]} text-semi-white`}>
          ...
          <div className="mb-8">
            <h2 className={`${styles["scroll-title"]} text-white`}>Create LinkedIn-Specific Content 
            </h2>
            <p className={`${styles["scroll-description"]} text-semi-white`}>
          ...
          <div className="mb-8">
            <h2 className={`${styles["scroll-title"]} text-white`}>Engage with Your Audience</h2>
            <p className={`${styles["scroll-description"]} text-semi-white`}>Interacting with followers builds trust. We monitor your LinkedIn profile to respond thoughtfully to comments and messages, enhancing relationships with your audience. This interaction establishes trust and fosters a loyal community around your brand.We produce well-researched documents that establish your brand’s thought leadership and credibility.
            </p>
            <div className="border-b-2 border-gray-300 my-4"></div>
          </div>
          <div className="mb-8">
            <h2 className={`${styles["scroll-title"]} text-white`}>Drive Website Traffic
            </h2>
            <p className={`${styles["scroll-description"]} text-semi-white`}>
          ...
          <div className="mb-8">
            <h2 className={`${styles["scroll-title"]} text-white`}>Create LinkedIn ads and landing pages</h2>
            <p className={`${styles["scroll-description"]} text-semi-white`}>
          ...
          <div className="mb-8">
            <h2 className={`${styles["scroll-title"]} text-white`}>Provide In-Depth Campaign Reporting</h2>
            <p className={`${styles["scroll-description"]} text-semi-white`}>
