    ...
    <h3 className={`${styles["quality-title"]} ${monsterfont.className} font-bold mb-2`}>
      WORTH EVERY PENNY
          ...
          <div className="pl-4 pr-8 py-6 relative z-0">
            ...
            AlgorithmX is committed to exploring all possibilities to deliver top-notch and innovative Magento development services customized to suit all your requirements and surpass your expectations.
            </p>
          </div>
        </div>
      </div>
