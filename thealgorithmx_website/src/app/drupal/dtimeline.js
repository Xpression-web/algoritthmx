...
const timelineSteps = [
  {
    ...
    title: "Requirements",
    description:
      "Our Drupal development consulting team works closely with you to establish and finalize the scope of your project.",
    color: "text-red-500",
    dotColor: "bg-red-500",
  },
  {
    ...
    title: "Roadmap",
    description:
      "After reviewing your business goals, our Drupal developers for hire formulate a personalized and structured plan to assist you in accomplishing them.",
    color: "text-red-400",
    dotColor: "bg-red-400",
  },
  {
    ...
    title: "Designing",
    description:
      "In our custom Drupal theme development process, we carefully plan out the desired UI’s blueprint, and then the wireframes and mockups are given the finishing touches.",
  ...
  },
  {
    ...
    title: "Development",
    description:
      "The next step is offshore Drupal development, where we build the store based on your defined specifications.",
  ...
  },
  {
    ...
    title: "Testing",
    description:
      "Our Drupal development company rigorously tests each version of the store built by our experienced Drupal developer in USA, ensuring its reliability before sharing it with you.",
  ...
  },
  {
    ...
    title: "Deployment",
    description:
      "Once you are satisfied with the final outcome, your Drupal website is deployed and goes live, marking its official launch.",
    color: "text-yellow-400",
    dotColor: "bg-yellow-400",
  },
];

const  DrupalDevelopmentTimeline = () => {
  return (
...
export default DrupalDevelopmentTimeline;