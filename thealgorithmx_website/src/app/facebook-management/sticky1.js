    ...
    <div ref={cardRef} className="h-screen sticky top-0 flex items-center justify-center px-4 md:px-8">
      <motion.div
        style={{
         ...
         className="relative w-full max-w-[1100px] h-[700px] md:h-[600px] rounded-xl p-4 md:p-8 flex flex-col border-2 border-pink-500 overflow-y-auto md:overflow-visible"
      >
