        ...
        <div className="flex flex-col md:flex-row items-center justify-between py-16 md:py-24 gap-8">
          ...
          <div className="w-full md:w-1/2 text-white order-2 md:order-1  ">
            ...
            <p className="text-semi-white text-[16px] leading-[26px] font-[300] font-['Helvetica']">
              At AlgorithmX, we craft powerful, targeted strategies to capture and
              engage your audience. We ensure your Facebook presence remains
              dynamic, relevant, and aligned with your business objectives. Whether
              you're looking to attract new customers or manage Meta ads, our
              tailored approach keeps users hooked, helping you build a loyal
              community while continuously expanding your reach.
            </p>
          </div>
