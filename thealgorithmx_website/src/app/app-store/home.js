    ...
    return (
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 py-12 ">
            ...
            <div className="w-full md:w-1/3">
                ...
                <img
                    src="images/App-Store-Optimization.webp"
            ...
            Comprehensive app store optimization services of AlgorithmX drive downloads and enhance your app’s visibility to reach the desired audience and gain top rankings.
            </p>
            </div>
        </div>
        </div>
