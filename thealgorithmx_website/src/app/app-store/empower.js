...
const AppServices = () => {
  ...
  <h1
    className={`${styles["services-text"]} ${monsterfont1.className} mb-8 md:mb-0 text-center text-3xl`}
  >
    Empower your Business
  </h1>
  <h1
    className={`${styles["services-text"]} ${monsterfont1.className} mb-8 md:mb-16 text-center text-3xl`}
  >
    With ASO
  </h1>
  ...
  <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row">
    ...
    <div
  className={`pt-6 pr-12 pl-12 pb-8 ${styles["box-border1"]} rounded w-full h-[1091px] md:h-auto `}
>
