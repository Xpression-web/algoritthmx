...
const TechnologyToolbox = () => {
  const tools = [
    ...
    { id: 'ak', name: 'Ads Manager', image: 'images/Facebook-Ads-Manager.png' },
    { id: 'ps', name: 'Facebook Analytics', image: 'images/Facebook-Analytics.png' },
    { id: 'id', name: 'Audience Insights', image: 'images/Facebook-Audience-Insights.png' },
    { id: 'canva', name: 'Business Suite', image: 'images/Facebook-Business-Suite.png' },
    { id: 'figma', name: 'Facebook-Experiments', image: 'images/Facebook-Experiments.png' },
    { id: 'cs', name: 'Facebook Pixel', image: 'images/Facebook-Pixel.png'},
    { id: 'stock', name: 'Hootsuite', image: 'images/Hootsuite.png' },
    { id: 'un', name: 'Lookalike Audiences', image: 'images/Lookalike-Audiences.png' },
  ];
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        Facebook Ads’ tech stack blends powerful audience targeting, smart AI optimization, insightful analytics, dynamic bidding, and seamless tracking to boost ad performance.
        </p>
