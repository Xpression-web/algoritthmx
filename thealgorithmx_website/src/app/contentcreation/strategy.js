    ...
    <div className="bg-black text-white flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="text-center mb-24 relative pt-20 pb-8 max-w-[1200px]">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span
            ref={scalableRef}
            className={`aligned-text text-gray-600/20 select-none ${monsterfont.className} transform transition-transform duration-700 ${
        ...
        <div className="relative z-2 mt-[54px]">
          <h2 className={`aligned-subtitle text-white ${monsterfont2.className} `}>
            SYNERGIZED WITH
          </h2>
          <h3 className={`aligned-subtitle ${monsterfont1.className} text-white`}>
            YOUR STRATEGY
          </h3>
        </div>
      </div>
      ...
      <div className="w-full max-w-7xl px-4">
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 mb-6">
          <div className="bg-[#222] rounded-md p-6 flex items-center justify-between md:w-72 cursor-pointer transition-colors duration-300">
            <span className="aligned-content">Lead Generation</span>
            <img src="images/lead-generation.png" alt="Lead Generation" className="w-8 h-8" />
          </div>
          
          <div className="bg-[#222] rounded-md p-6 flex items-center justify-between md:w-72 cursor-pointer transition-colors duration-300">
            <span className="aligned-content">Sales Enablement</span>
            <img src="images/sales.png" alt="Sales Enablement" className="w-8 h-8" />
          </div>
          
          <div className="bg-[#222] rounded-md p-6 flex items-center justify-between md:w-72 cursor-pointer transition-colors duration-300">
            <span className="aligned-content">Nurturing Customers</span>
            <img src="images/nuturing.png" alt="Nurturing Customers" className="w-8 h-8" />
          </div>
          
          <div className="bg-[#222] rounded-md p-6 flex items-center justify-between md:w-72 cursor-pointer transition-colors duration-300">
            <span className="aligned-content">Social Engagement</span>
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6">
          <div className="bg-[#222] rounded-md p-6 flex items-center justify-between md:w-72 cursor-pointer transition-colors duration-300">
            <span className="aligned-content">Thought Leadership</span>
            <img src="images/leadership.png" alt="Thought Leadership" className="w-8 h-8" />
          </div>
          
          <div className="bg-[#222] rounded-md p-6 flex items-center justify-between md:w-72 cursor-pointer transition-colors duration-300">
            <span className="aligned-content">Conversions</span>
            <img src="images/conversion.png" alt="Conversions" className="w-8 h-8" />
          </div>
          
          <div className="bg-[#222] rounded-md p-6 flex items-center justify-between md:w-72 cursor-pointer transition-colors duration-300">
            <span className="aligned-content">Search Engine Optimization</span>
