...
export default function Content() {
  return (
    <div className="bg-black min-h-screen flex justify-center items-center">
      <div className=" container1 w-full max-w-[1200px] mx-auto algo-content-creation-services">
        {/* Left Section (Sticky) */}
  <div className="flx_left flex flex-col lg:flex-row">
  <div className="flex flex-col md:flex-col lg:flex-col space-y-2">
      <span className={`explore ${monsterfont1.className} text-white`}>Explore Our</span>
      <div className="space-x-2">
      <span className={`explore ${monsterfont.className} text-white`}>Content</span>
      </div>
      <div>
      <span className={`explore ${monsterfont.className} text-white`}>Creation</span>
      </div>
      <span className={`explore ${monsterfont.className} text-white`}>Variety</span>
  </div>

  {/* Vertical Line and Text */}
  <div className="flex items-center">
    <div className="h-20 border-l-8 border-blue-500 rounded-full mr-6"></div>
    <p className={`content text-semi-white`}>
      ...
      <span className={` ${monsterfont2.className}`}>OF CONTENT</span>
        ...
        <div className="mb-8">
            <h2 className="scroll-title text-white">Article Writing</h2>
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Product Description</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">White Paper</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Blog Writing</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Website Content</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">SEO Writing</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Press Release</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Article Rewriting</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Copy Writing</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">FAQ's</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Newsletter Writing</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Technical Content Writing</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Emailers</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Case Studies</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Magazine Writing</h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">E-book </h2>
            <p className="scroll-description text-semi-white">
          ...
          <div className="mb-8">
            <h2 className="scroll-title text-white">Social Media Posts</h2>
            <p className="scroll-description text-semi-white">
