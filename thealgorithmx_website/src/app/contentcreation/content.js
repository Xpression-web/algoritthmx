      ...
      <div className={`${styles["container1"]} w-full max-w-[1200px] mx-auto ${styles["algo-content-creation-services"]}`}>
        ...
        <div className={`${styles["flx_left"]} flex flex-col lg:flex-row`}>
          <div className="flex flex-col md:flex-col lg:flex-col space-y-2">
            <span className={`${styles["explore"]} font-helveticaneue text-white`}>Explore Our</span>
            <div className="space-x-2">
              <span className={`${styles["explore"]} font-helveticaneue text-white`}>Content</span>
            </div>
            <div>
              <span className={`${styles["explore"]} font-helveticaneue text-white`}>Creation</span>
            </div>
            <span className={`${styles["explore"]} font-helveticaneue text-white`}>Variety</span>
          </div>
