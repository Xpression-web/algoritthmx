...
const timelineSteps = [
  {
    ...
    title: "Requirements",
    description:
      "Our premier BigCommerce development agency works closely with you to establish and finalize the scope of your project.",
    color: "text-red-500",
    dotColor: "bg-red-500",
  },
  {
    ...
    title: "Roadmap",
    description:
      "After reviewing your business goals, our expert BigCommerce developers formulate a personalized and structured plan to assist you in accomplishing them.",
    color: "text-red-400",
    dotColor: "bg-red-400",
  },
  {
  ...
  },
  {
    ...
    title: "Development",
    description:
      "The next step is custom BigCommerce store development, where we build the store based on your defined specifications.",
  ...
  },
  {
    ...
    title: "Testing",
    description:
      "Our BigCommerce development agency rigorously tests each version of the store built by our BigCommerce web developers in USA, ensuring its reliability before sharing it with you.",
  ...
  },
  {
    ...
    title: "Deployment",
    description:
      "Once you are satisfied with the final outcome, your Bigcommerce store is deployed and goes live, marking its official launch.",
...
export default BigcommerceDevelopmentTimeline;