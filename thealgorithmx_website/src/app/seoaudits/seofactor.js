  ...
  return (
    <div className='min-h-screen p-4 md:p-8 bg-black text-white flex items-center justify-center'>
      ...
      <div className="text-center mb-8 md:mb-12">
        <h2 className="text-blue-400 font-['Helvetica'] leading-[18px] font-[18px] font-[700]  text-center">COMMON ISSUES</h2>
          ...
          <div className="md:hidden flex flex-col h-full">
            ...
            <div className="flex-1 overflow-hidden p-4">
              <div key={activeTab} className={contentClasses}>
                <h3 className={`text-[34px] leading-[42px] ${monsterfont.className} mb-5`}>{content[activeTab].title}</h3>
