...
const SeoFactors = () => {
    ...
    const content = {
        ...
        "sync-strategy": {
            mainTitle: "Server-Files",
            boxTitle: "Server-Level Factors",
    ...
    return (
        ...
        <h2 className={`text-[#2775ff] leading-[18px] font-[18px] ${monsterfont2.className} text-center`}>COMMON ISSUES</h2>
            <h1 className={`leading-[40px] text-[36px] md:text-[56px] mt-[20px]  text-center  ${monsterfont1.className} `}>
              FACTORS
            </h1>
            <h1 className={`leading-[40px] text-[36px] md:text-[56px] mt-[20px]  text-center  ${monsterfont.className} `}>
              IMPACTING YOUR SEO
            </h1>
        </div>
                    ...
                    <div className="hidden md:flex h-full p-4">
                        ...
                        <div className="flex flex-col space-y-8 pr-14 justify-center">
                            ...
                            >
                                ...
                                <span className={`font-helveticaneue text-[15px] leading-[22px] ml-[8px] ${activeTab === key ? 'text-white' : 'text-[#FFFFFF80] group-hover:text-[#d7d7d7] transition-colors duration-700'}`}>
                                    {value.mainTitle}
                                </span>
                            </button>
                            ))}
