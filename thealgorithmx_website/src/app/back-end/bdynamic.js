  ...
  const steps = [
    {
      number: 1,
      title: "Discovery",
      description: "The first step in back end development involves gathering comprehensive information about the vision, goals, and objectives of the client’s business, creating mockups for client review, and making necessary changes according to their feedback. "
    },
    {
      number: 2,
      title: "Planning",
      description: "In the next stage, our expert back end developer picks the best tools, frameworks, and libraries to be used throughout the development journey and performs initial server testing to ensure that it supports the web application."
    },
    {
      number: 3,
      title: "Prototyping",
    ...
    },
    {
      number: 4,
      title: "Development",
      description: "The next phase of our back end development in USA is constructing a stable development environment, integrating APIs, third-party services, and backend systems, and transforming the approved functionalities and designs into actual codes."
    },
    {
        number: 5,
        title: "Testing",
        description: "In this stage, our talented back end developer conducts thorough manual and automated testing to ensure that the web app works seamlessly across all devices, operating systems, and browsers and adheres to W3C standards, resulting in a reliable and efficient app."
      },
      {
        number: 6,
        title: "Delivery",
...
export default BackDesignProcess;