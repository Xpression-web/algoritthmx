...
const TechnologyToolbox = () => {
  const tools = [
    { id: 'ae', name: 'AdRoll dynamic ads', image: 'images/AdRoll-dynamic-ads.png' },
    { id: 'ai', name: 'Agency Analytics', image: 'images/AgencyAnalytics.png' },
    { id: 'hot', name: 'Criteo Dynamic', image: 'images/Criteo-Dynamic-Retargeting.png' },
    { id: 'ak', name: 'Facebook Dynamic ', image: 'images/.png' },
    { id: 'ps', name: 'Google Dynamic Ads', image: 'images/Google-Ads-Dynamic-Remarketing.png' },
  ];
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        The remarketing tech stack leverages tracking tools, smart audience segmentation, dynamic ads, behavior analysis, automated workflows, and personalized content delivery.
        </p>
