    ...
    <div className="min-h-screen bg-black pt-[100px]">
      <div className="max-w-[1200px] mx-auto px-4 md:px-2 py-10">
        ...
        <div className="mt-8 md:mt-12 text-center">
          ...
          At AlgorithmX, we transform Machine Learning into a strategic enabler, ensuring accuracy, efficiency, and seamless integration. With advanced automation and robust model evaluation, we minimize risks, accelerate development, and future-proof AI-driven solutions for market success.
          </p>
        </div>
      </div>
    </div>
