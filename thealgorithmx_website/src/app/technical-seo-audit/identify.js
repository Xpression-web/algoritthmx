    ...
    return (
        ...
        <div className="container max-w-[1200px] mx-auto">
            ...
            <div className="w-full lg:w-1/2 space-y-2">
                ...
                success. Our commitment to full transparency means you’ll receive regular updates and reports, so you’re always informed of your 
                progress and improvements. Whether you’re a growing business or an industry leader, our technical SEO services are designed to 
                elevate your rankings and drive impactful results.
                </p>
            </div>
