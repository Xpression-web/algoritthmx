        ...
        <div className="flex flex-col md:flex-row items-center justify-center max-w-6xl w-full gap-4">
          <div className="flex-1 flex justify-center order-2 md:order-1">
            <img
              ...
              alt="Core Value 3"
              className="w-full h-auto md:max-w-xl  object-cover rounded-lg shadow-lg md:p-4"
            />
          </div>
          <div className="flex-1 text-white px-4 order-1 md:order-2">
            <h3 className={`font-size-30 md:font-size-36 algo-line-height-1 ${monsterfont.className} md:text-start text-center mb-4`}>
            Our Vision and Mission
            </h3>
            <p className={`${monsterfont.className} text-semii-white  md:text-start text-center`}>
      ...
      <section className="flex items-center justify-center bg-black min-h-screen py-8 ">
        <div className="flex flex-col md:flex-row items-center justify-center max-w-6xl  w-full gap-4">
          <div className="flex-1 text-white px-4 order-1">
            <h2 className={`font-size-36 algo-line-height-1 ${monsterfont1.className} mb-4  md:text-start text-center`}>
              Our Core Values
            </h2>
            <p className={`${monsterfont.className} text-semii-white  md:text-start text-center`}>
