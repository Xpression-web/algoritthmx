...
const TechnologyToolbox = () => {
  const tools = [
    ...
    { id: 'hot', name: 'Hootsuite', image: 'images/Hootsuite.png' },
    { id: 'ak', name: 'LinkedIn Analytics', image: 'images/LinkedIn-Analytics.png' },
    { id: 'ps', name: 'Audience Network', image: 'images/LinkedIn-Audience-Network.png' },
    { id: 'id', name: 'Business Solutions', image: 'images/LinkedIn-Business-Solutions.png' },
    { id: 'canva', name: 'Campaign Manager', image: 'images/LinkedIn-Campaign-Manager.png' },
    { id: 'figma', name: 'LinkedIn Experiments', image: 'images/LinkedIn-Experiments.png' },
    { id: 'cs', name: 'Insights', image: 'images/LinkedIn-Insight-Tag.png'},
    { id: 'stock', name: 'Matched Audiences', image: 'images/LinkedIn-Matched-Audiences.png' },
  ];
  ...
  return (
    <div className="bg-black text-white py-8 px-2 sm:py-16 sm:px-4">
      <div className="max-w-6xl mx-auto">
        ...
        Instagram Ads' tech stack leverages precise audience insights, machine learning algorithms, real-time analytics, dynamic bidding, and conversion tracking tools.
        </p>
